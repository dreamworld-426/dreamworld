...
/*
    ...
    update(timeStamp, x, y, z) {
      ...
      if(z > this.state.chunkWidth/2) {
        ...
        let chunk1 = new Chunk(this, this.state.chunkWidth + this.state.currentXOffset, 0, this.state.chunkWidth + this.state.currentZOffset);
        let chunk2 = new Chunk(this, this.state.currentXOffset, 0, this.state.chunkWidth + this.state.currentZOffset);
        let chunk3 = new Chunk(this, -this.state.chunkWidth + this.state.currentXOffset, 0, this.state.chunkWidth + this.state.currentZOffset);

        // debugger;
        // move all pieces to correct position relative to center block
        // top row
        chunk1.setChunkPosition(this.state.chunkWidth, 0, this.state.chunkWidth)
        chunk2.setChunkPosition(0, 0, this.state.chunkWidth)
        chunk3.setChunkPosition(-this.state.chunkWidth, 0, this.state.chunkWidth)

        this.state.chunks[0] = chunk1;
        this.state.chunks[1] = chunk2;
        this.state.chunks[2] = chunk3;
